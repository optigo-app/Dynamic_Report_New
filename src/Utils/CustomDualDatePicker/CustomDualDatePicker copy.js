...
const CustomDualDatePicker = ({ value = {}, onChange = () => { }, dateColumnOptions,
                    ...
                    InputProps={{
                        startAdornment: (
                            <>
                                <Chip
                                    label={
                                        dateColumnOptions.find(o => o.field === tempRange.status)?.label
                                        || "Date Type"
                                    }
                                    size="small"
                                    onClick={(e) => {
                                ...
                                <MenuList options={dateColumnOptions} anchorEl={anchorElStatus} open={Boolean(anchorElStatus)} handleClose={() => setAnchorElStatus(null)} handleSelect={handleStatusSelect} selectedValue={tempRange?.status || "All"} />
                            </>
                        ),
